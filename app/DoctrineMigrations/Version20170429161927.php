 ...
 */
class Version20170429161927 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE customer_account ADD CONSTRAINT FK_61EBF21AA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
